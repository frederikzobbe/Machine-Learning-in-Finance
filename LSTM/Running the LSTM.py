...
LSTM_plot(save = 'no', name = 'plot', dataset = dataset, predictions=pred_dax_update, predict_from_day=train_to_date, features_used=features_used, look_back = look_back, size_hidden=size_hidden, num_epochs=num_epochs, pen_negativity_factor=pen_negativity_factor, view=200)
